...
lvl3_vodka = lmer(vodka_price_change ∼ alcohol_togo + Suggested_code_bar+(1|tract_code), both_wave_data, REML=FALSE)
summary(lvl3_vodka)

lvl3_beer = lmer(beer_price_change ∼ alcohol_togo + Suggested_code_bar + (1|tract_code), both_wave_data, REML=FALSE)
summary(lvl3_beer)
